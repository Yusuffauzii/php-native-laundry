...
if (! is_null($id_user))
{
	$id_user = $db->get_by_kasir($id_user);
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method= "post" action="../inputdata.php?action=updatekasir">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">ID kasir</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="id_user" value="<?php echo $id_user['id_user']; ?>" >
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="nm_user" value="<?php echo $id_user['nm_user']; ?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Password</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="password" value="<?php echo $id_user['password']; ?>">
                </div>
                <div class="form-group">
