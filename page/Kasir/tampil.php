      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="tampil.php"><i class="fa fa-circle-o"></i> Kasir</a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Table Kasir</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
              $no = 1;
              foreach ($db->tampil_data_kasir() as $x){
              ?>
              <tr>
              <td><?php echo $no++; ?></td>
              ...
              <td>
                  <a class="btn btn-info" href="edit.php?id=<?php echo $x['id_user']; ?>&aksi=edit"><i class="fa fa-edit"></i></a>
                  <a class="btn btn-danger" href="../inputdata.php?action=deletekasir&idkasir=<?php echo $x['id_user']; ?>" ><i class="fa  fa-trash-o"></i></a>
              </td>
              </tr>
              <?php } ?>
                </tfoot>
