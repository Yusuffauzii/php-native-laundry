...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method= "post" action="../inputdata.php?action=addtran">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">ID Transaksi</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="id_transaksi" >
                </div>
                <div class="form-group">
                <label for="exampleInputEmail1">ID Pelanggan</label>
                  <select class="form-control select2" name="id_pelanggan" style="width: 100%;">
                  <option selected="selected">Pilihlah</option>
                  <?php
                  foreach 
                  ($db->tampil_data() as $x){
                    echo "<option value = ". $x['id_pelanggan'].">".$x['id_pelanggan']."</option>";
                  } 
                  ?>
                  </select>
                </div>
                ...
                <label for="exampleInputEmail1">ID Kasir</label>
                  ...
                  <?php
                  foreach 
                  ($db->tampil_data_kasir() as $x){
                    echo "<option value = ". $x['id_user'].">".$x['id_user']."</option>";
                  } 
                  ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="exampleInputEmail1" name="tgl_transaksi" >
                </div>
                <div class="form-group">
                  ...
                  <?php
                  foreach 
                  ($db->tampil_data_paket() as $x){
                    echo "<option value = ". $x['id_paket'].">".$x['nm_paket']."</option>";
                  }
                  ?>
                  </select>
                  </div>
                  ...
                  <select class="form-control select2" name="harga" style="width: 100%;">
                  <option selected="selected">Pilihlah</option>
                  <?php
                  foreach 
                  ($db->tampil_data_paket() as $x){
                    echo "<option value = ". $x['harga'].">".$x['harga']."</option>";
                  }
                  ?>
                  </select>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="jml_kilo" >
                </div>
