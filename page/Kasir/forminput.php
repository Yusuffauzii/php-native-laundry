...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method= "post" action="../inputdata.php?action=addkasir">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">ID kasir</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="id_user" >
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="nm_user" >
                </div>
                <div class="form-group">
