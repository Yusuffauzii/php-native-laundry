...
if (! is_null($id_paket))
{
	$id_paket = $db->get_by_paket($id_paket);
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method= "post" action="../inputdata.php?action=updatepaket">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">ID Pelanggan</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="id_paket" value="<?php echo $id_paket['id_paket']; ?>" >
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="nm_paket" value="<?php echo $id_paket['nm_paket']; ?>">
                </div>
                <div class="form-group">
