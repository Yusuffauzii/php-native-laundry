    ...
    <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <td><?php echo $x['hp']; ?></td>
                <td>
                <a class="btn btn-info"href="edit.php?id=<?php echo $x['id_pelanggan']; ?>&aksi=edit"><i class="fa fa-edit"></i></a>
                <a class="btn btn-danger" href="../inputdata.php?action=delete&id=<?php echo $x['id_pelanggan']; ?>"><i class="fa  fa-trash-o"></i></a>
                </td>
              </tr>
              <?php } ?>
                </tfoot>
