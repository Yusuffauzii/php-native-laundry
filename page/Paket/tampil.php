    ...
    <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                $no = 1;
                foreach ($db->tampil_data_paket() as $x){
                ?>
                <tr>
                <td><?php echo $no++; ?></td>
                ...
                <td>
                <a class="btn btn-info" href="edit.php?id=<?php echo $x['id_paket']; ?>&aksi=edit"><i class="fa fa-edit"></i></a>
                <a class="btn btn-danger" href="../inputdata.php?action=deletepaket&idpaket=<?php echo $x['id_paket']; ?>"><i class="fa  fa-trash-o"></i></a>
                </td>
              </tr>
              <?php } ?>
                </tfoot>
